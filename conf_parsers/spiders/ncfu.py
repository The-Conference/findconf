...
class NcfuSpider(CrawlSpider):
    ...
    start_urls = ["https://www.ncfu.ru/science/scientific-events/",
                  # "https://www.ncfu.ru/science/scientific-events/Proedie-meropriyatiya/"
                  ]
    rules = (
        Rule(LinkExtractor(restrict_css='div.static-content li', restrict_text='онференц'),
    ...
    def parse_items(self, response):
        ...
        new_item.add_css('conf_name', "h1.h4::text")

        for line in response.xpath("//div[@class='static-content']//*[self::p or self::ul or self::ol]"):
