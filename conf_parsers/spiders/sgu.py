...
class SguSpider(CrawlSpider):
    ...
    rules = (
        Rule(LinkExtractor(restrict_css='td.views-field-name-field-et', restrict_text='онференц'),
    ...
    def parse_items(self, response):
        ...
        contacts = side_block.css("div.field-name-field-servicechanne-contacts").xpath("string(.)").get()
