...
class FaSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        querystring = {"List": "{278AC31B-3FAD-452A-9C38-16E6C6D269F2}",
                       "View": "{5E35A48D-EEA6-4F31-BE9A-8B6E2A9ABC97}", "ViewCount": "84", "IsXslView": "TRUE",
                       "IsCSR": "TRUE", "ListViewPageUrl": "http://www.fa.ru/org/div/oniiprs/News/Forms/AllPages.aspx",
                       "FilterField1": "Category", "FilterValue1": "Новости и объявления"}

        yield scrapy.Request(url=url + urlencode(querystring), method='POST', callback=self.parse_links)
