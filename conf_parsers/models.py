...
class AbstractItem(Base):
    ...
    un_name = Column(
        String(500), nullable=False, doc="University name. Given in the spiders' properties."
    )
    local = Column(
        Boolean,
        default=True,
        doc='False in the conference is international. '
    ...
    short_description = Column(
        String, nullable=True, default=null(), doc='Conference short description. Parsed.'
    )
    description = Column(
...
class ConferenceItemDB(AbstractItem):
    ...
    org_name = Column(
        String, nullable=True, default=null(), doc='Conference organisers. Field unused.'
    )
    online = Column(
        Boolean, default=False, doc='True if the conference is accessible on the Internet. Parsed.'
    )
    conf_href = Column(
        String(500),
        nullable=True,
        default=null(),
        doc='Dedicated website of the conference. Parsed.',
    )
    ...
    rinc = Column(
        Boolean,
        default=False,
        doc='Citation database: Российский индекс научного цитирования. Parsed.',
    )
    vak = Column(
        Boolean, default=False, doc='Citation database: Высшая Аттестационная Комиссия. Parsed.'
    )
...
class GrantItemDB(AbstractItem):
    __tablename__ = 'Conference_data_grant'
