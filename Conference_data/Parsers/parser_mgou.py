...
def make_parse_mgou(un_id, url, filter_date):
    try:
        ...
        try:
            ...
            tables = main_container.find_all('div', class_='TableHTML_wrapper__ldeAR')
            ...
            for table in tables:
                for line in table.find_all('tr'):
                    ...
                    if 'конфер' in line.find_all('td')[1].text.lower():
                        ...
                        dates_ = f"01 {line.find_all('td')[2].text}" if len(line.find_all('td')[2].text.split()) == 2 else \
                        ...
                        org_name = line.find_all('td')[3].text
                        contacts = ''
...
def parser_mgou(un_id, urls, date_):
    try:
        for url in urls:
            make_parse_mgou(un_id, url, date_)
